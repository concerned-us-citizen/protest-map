...
<svg id="a" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48">
  <circle id="b" cx="24.15" cy="23.87" r="22" fill="none" stroke="currentColor" style="opacity: .4; stroke-linecap: round; stroke-linejoin: round; stroke-width: 3.2px;"/>
  <g id="c">
    <path fill="currentColor" id="d" d="M16.48,15.66c0-2,.8-3.92,2.21-5.34,1.42-1.41,3.33-2.21,5.34-2.21s3.92.8,5.34,2.21c1.41,1.41,2.21,3.33,2.21,5.34s-.8,3.92-2.21,5.33c-1.42,1.42-3.33,2.21-5.34,2.21s-3.92-.79-5.34-2.21c-1.41-1.41-2.21-3.33-2.21-5.33ZM25.12,24h-2.19c-3,0-5.87,1.19-7.98,3.31-2.12,2.12-3.31,4.99-3.31,7.98,0,1.19.81,2.23,1.97,2.51,3.41.86,6.91,1.29,10.42,1.29,3.51,0,7.01-.43,10.42-1.29,1.16-.28,1.97-1.32,1.97-2.51,0-3-1.2-5.87-3.31-7.98-2.12-2.12-4.99-3.31-7.98-3.31h0Z"/>
  </g>
</svg>
`;
